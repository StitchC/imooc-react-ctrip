...
export type ProductListData = Array<ProductData>


export const productList1:Array<ProductData> = [
  {
    id: 1,
    title:
...
// 新品上市
export const productList2:Array<ProductData> = [
  {
    id: 10,
    title:
...
// 国内游推荐
export const productList3:Array<ProductData> = [
  {
    id: 19,
    title:
